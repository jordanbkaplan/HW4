...
class Cardclasstests(unittest.TestCase):
	...
	def test_init4(self):
		p=Card(1,3)
		self.assertEqual(p.suit, "Clubs")
	def test_init5(self):
		c=Card(suit=2)
		self.assertEqual(c.suit, "Hearts")
	def test_str(self):
		p=Card(2,7)
		self.assertEqual(str(p), "7 of Hearts")
	def test_suitaccess(self):
		p=Card(2,10)
		self.assertEqual(p.suit_names, ["Diamonds","Clubs","Hearts","Spades"])
	def test_deck(self):
		p=Deck()
	...
	def test_pop(self):
		p=Deck()
		c=Card()
		self.assertEqual(type(p.pop_card()),type(c))
	def test_war(self):
		p=play_war_game()
	...
	def test_mine(self):
		p=Card(2,7)
		self.assertEqual(p.faces, {1:"Ace",11:"Jack",12:"Queen",13:"King"})
	def test_mine2(self):
		p=Card(2,7)
		self.assertEqual(type(p.faces), dict)
